...
6a.  HTML(ERB) - this is html with embedded ruby, this allows a combination of the standard website creating language and that of Ruby.  

6b.  CSS(SCSS) - Allows styling of the above HTML pages.  

6c.  Bootstrap - Bootstrap allows convenient templates/styling for website components. 

6d.  Ruby - Common programming language.  

6e.  Ruby on rails - Common website app framework of which includes everything needed to assemble a web application, runs on   Model, View and Controller system.  (integrates Ruby Language)

6f.  GitHub - allows all members of the team to contribute and work simultaneously on the project, providing a tool to merge work, save, manage and rollback to prior versions of the project if needed.  

6g.  Heroku - Heroku is a platform as a service (PaaS) that enables developers to build, run, and operate applications entirely in the cloud.    

6h.  Stripe - A standard payment system, of which was integrated into the website, allows the users to pay for the booking of campsites.  

6i.  Devise - Devise is a flexible authentication solution for Rails based on Warden
https://github.com/plataformatec/devise

6j.  Simple calendar(gem) - Allowed us to integrate a calendar booking system to the website, easing user experience.  

6k.  AWS S3 - Amazon Web Services offers reliable, scalable, and inexpensive cloud computing services.

6l.  PostgreSQL - PostgreSQL is an object-relational database management system.
----------------------------------------------------------------------------------------------------------------------------
...
11a.  A multitude of Gems installed, (gemfile attached)

11b.  Stripe - A standard payment system, of which was integrated into the website, allows the users to pay for the booking of campsites. 

11c.  Devise - Devise is a flexible authentication solution for Rails based on Warden
https://github.com/plataformatec/devise

11d.  Heroku - Heroku is a platform as a service (PaaS) that enables developers to build, run, and operate applications entirely in the cloud.    

11e.  AWS S3 - Amazon Web Services offers reliable, scalable, and inexpensive cloud computing services.
----------------------------------------------------------------------------------------------------------------------------
...
14a.   Bookings has the following relationship attributes:
  belongs to: user
  belongs to: listing
...
14b.  Class Listing has the following relationship attributes:
...
14c.  class User has the following relationship attributes:
  has_many: bookings, dependent: destroy
...
18a.  We used Trello, of which allowed us to assume a basic to do list, with priorities and task assignment.    

18b.  Vocally we set a few major vague deadlines, such as "complete backend by Thursday week 1” of which were more competitive goals than strict deadlines.  

18c.  On top of this there was constant communication, we would revisit and check up on progress every few hours and maintain an open dialogue.  

18d.  This as well as the daily check-ups ensured we were on top of progress.  
